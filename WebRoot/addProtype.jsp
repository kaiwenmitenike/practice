...
<html>
  <head>
    ...
    <script type="text/javascript" src="englishJs/addProtype.js"></script>
    <style>
        .je-field .je-btn {
            margin: 0 7px 10px 0;
        }
  ...
  <div class="je-p20">
    ...
    <blockquote class="je-quote je-f16">
    		...
    		<button class="je-btn je-bg-native je-rdu" onclick="addProtype();">添加完形填空</button>
    </blockquote>
    <form action="" id="protype_id">
    	<input type="hidden" value="0" name="status" id="statusId"/>
     <div class="je-form-pane">
    <div class="je-form-item">
        <label class="je-label je-f14">完型标题</label>
        <div class="je-inputbox">
            <input type="text" name="title" id="title" autocomplete="off" placeholder="请输入完型标题" class="je-input">
        </div>
    </div>
    </div>
    <div class="je-form-pane">
        <div class="je-form-text">
        <label class="je-label je-f14">完型文章</label>
        <textarea placeholder="请输入完型文章" name="protype" id="protype" class="je-textarea"></textarea>
        </div>
    </div>
    </form>
